...
<body>
    ...
    <div class="mt-5 mx-5 text-center">
        <div>
            <h2>Selamat Datang, Pegawai RS Medika Mantap</h2>
        </div>
    </div>
        ...
        <div class="mx-5 card" style="width: 18rem;">
            <img class="card-img-top" src="asset/image/image2.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="index_viewSM.php" class="btn btn-primary">Lihat</a>
                </div>
        </div>
        </div>
        <div class="p-2">
        <div class="mx-5 card" style="width: 18rem;">
            <img class="card-img-top" src="asset/image/image2.jpg" alt="Card image cap">
                <div class="card-body">
                    ...
                    <a href="index_viewSK.php" class="btn btn-primary">Lihat</a>
                </div>
        </div>
        </div>
    </div>
